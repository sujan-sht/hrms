$(document).ready(function(){
    var checkUrl = window.location.origin + "/admin/payroll/tax-exclude-setup";
    ...
    remoteIncomeSetupOrderUrl = checkUrl + "/check-tax-exclude-setup-order" + "?id=" + id;
    $('#taxExcludeSetupFormSubmit').validate({
        rules: {
            order: {
                required: true,
                remote: remoteIncomeSetupOrderUrl,
            },
            'title' : 'required',
            'short_name' : 'required',
        },
