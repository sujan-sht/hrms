$(document).ready(function(){
    $('#grievance_submit').validate({
        ...
        messages: {
            'is_anonymous' : 'Chooose Anonymous',
            'subject_type' : 'Choose Subject Type',
        },
        errorElement: "em",
        ...
        highlight: function (element, errorClass, validClass) {
            ...
            $(element).next('div .form-control-feedback').addClass("text-danger").removeClass("text-success");
        ...
        unhighlight: function (element, errorClass, validClass) {
            ...
            $(element).next('div .form-control-feedback').addClass("text-success").removeClass("text-danger");
