$(document).ready(function(){
    $('#leaveDeductionSetupSubmit').validate({
        rules: {
            ...
            'max_late_days' : 'required',
            'deduct_leave_number' : 'required',
            'leave_type_id' : 'required',
            // 'unpaid_leave_type' : 'required',
        },
        messages: {
            'organization_id' : 'Organization is required',
            'type' : 'Type is required',
            'method' : {
                required : 'Leave Deduction number is required',
                min : 'No. of Leave Deduction should be minimum 0.5'
            },
            'max_late_days' : 'Max no. of limit is required',
            'deduct_leave_number' : 'No. of deduction leave is required',
            'leave_type_id' : 'Leave type is required',
            // 'unpaid_leave_type' : 'Unpaid leave type is required',
        },
        errorElement: "em",
