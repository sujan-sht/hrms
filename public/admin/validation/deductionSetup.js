$(document).ready(function(){
    var checkUrl = window.location.origin + "/admin/payroll/deduction-setup";
    ...
    remoteDeductionSetupOrderUrl = checkUrl + "/check-deduction-setup-order" + "?id=" + id;
    $('#deductionSetupFormSubmit').validate({
        rules: {
            // order: {
            //     required: true,
            //     remote: remoteDeductionSetupOrderUrl,
            // },
            'title' : 'required',
            'short_name' : 'required',
            'order' : 'required',
