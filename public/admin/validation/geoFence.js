$(document).ready(function () {
    $("#geofence_submit").validate({
        rules: {
            // "title": "required",
            "multi[0][latitude]": "required",
            "multi[0][longitude]": "required",
            "multi[0][radius]": "required",
            // "editcontact_no": {
            //     required: true,
            //     // minlength: 10,
            //     maxlength: 10,
        ...
        messages: {
            // "title": "Enter title",
            "multi[0][latitude]": "Enter Latitude",
            "multi[0][longitude]": "Enter Longitude",
            "multi[0][radius]": "Enter Radius(meter) ",
