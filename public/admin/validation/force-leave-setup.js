$(document).ready(function(){
    $('#forceLeaveSetupFormSubmit').validate({
        rules: {
            'include_holiday' : 'required',
            'include_dayoff' : 'required',
            'days_limit_from_doj' : 'required',
        },
        messages: {
            'include_holiday' : 'Select Option',
            'include_dayoff' : 'Select Option',
            'days_limit_from_doj' : 'Enter number',
        },
        errorElement: "em",
