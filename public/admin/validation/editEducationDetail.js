$(document).ready(function () {
    $(".validateUpdateEducationDetail").validate({
        rules: {
        ...
        messages: {
            "type_of_institution": "Enter Institution Type",
            "institution_name": "Enter Institution Name",
            "affiliated_to": "Enter Affiliated To",
            "attended_from": "Choose Date",
            "attended_to": "Choose Date",
            "passed_year": "Enter Passed Year",
            "level": "Enter Level",
            "note": "Enter Note",
        },
        errorElement: "em",
