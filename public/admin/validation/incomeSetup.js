$(document).ready(function(){
    var checkUrl = window.location.origin + "/admin/payroll/income-setup";
    ...
    remoteIncomeSetupOrderUrl = checkUrl + "/check-income-setup-order" + "?id=" + id;
    // remoteEmployeeCodeUrl = checkUrl + "/check-employee-code" + "?id=" + id;
    $('#incomeSetupFormSubmit').validate({
        rules: {
            // order: {
            //     required: true,
