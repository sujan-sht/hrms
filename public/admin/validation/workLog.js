$(document).ready(function () {
    $("#worklog_submit").validate({
        ignore: "input[type='time']",
        rules: {
            // "title": "required",
            "multi[0][title]": "required",
            "multi[0][status]": "required",
            "multi[0][hours]": "required",
        ...
        messages: {
            // "title": "Enter title",
            // "multi[0][title]": "Enter Title",
            // "multi[0][status]": "Chose Status",
            // "multi[0][hours]": "Chose Time",
