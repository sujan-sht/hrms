$(document).ready(function () {
    $("#payrollFormSubmit").validate({
        rules: {
            "organization_id": "required",
            "year": "required",
            "eng_year" : "required",
            "calendar_type" : "required",
            "eng_calendar_type" : "required",
            "month": "required",
            "eng_month" : "required",
        },
        messages: {
            ...
            "year": "Select Year",
            "calendar_type" : "Select Calendar type",
            "eng_calendar_type" : "Select Calendar type",
            "eng_year" : "Select Year",
            "month": "Select Month",
            "eng_month" : "Select Month ",
