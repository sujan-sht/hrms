$(document).ready(function () {
    $(".validateVisaAndImmigrationDetail").validate({
        rules: {
            "country": "required",
            "visa_type": "required",
        ...
        messages: {
            ...
            "visa_type": "Enter Visa Type",
            "issued_date": "Choose Date",
            // "visa_expiry_date": "Choose Date",
    ...
    $(".validateUpdateVisaAndImmigrationDetail").validate({
        rules: {
            "country": "required",
            "visa_type": "required",
            'issued_date': "required",
