$(document).ready(function () {
    $(".validateUpdateAssetDetail").validate({
        rules: {
            "editAssetType": "required",
            "editAssetDetail": "required",
            "editGivenDate": "required",
            "editReturnDate": "required",
        },
        messages: {
            "editAssetType": "Choose Asset Type",
            "editAssetDetail": "Enter Asset Detail",
            "editGivenDate": "Choose Given Date",
            "editReturnDate": "Enter Return Date",
        },
        errorElement: "em",
