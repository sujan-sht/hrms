$(document).ready(function () {
    $("#carrierMobilityFormSubmit").validate({
        rules: {
            "date": "required",
            "type_id": "required",
            ...
            "job_title": "required",
            "probation_status": "required",
            "payroll_change": "required",
        },
        messages: {
            'date': "Choose Date",
            "type_id": "Choose Type",
            "organization_id": "Select Option",
            "branch_id": "Select Option",
            "department_id": "Select Option",
            "level_id": "Select Option",
            "designation_id": "Select Option",
            "job_title": "Write functional title here..",
            "probation_status": "Select Option",
            "payroll_change": "Select Type",
        },
        errorElement: "em",
