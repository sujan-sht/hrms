$(document).ready(function () {
    $("#surveyQuestionFormSubmit").validate({
        rules: {
            "survey_id": "required",
            "question": "required",
            ...
            "option_c": "required",
            "option_d": "required",
            "multiple_option_status": "required",
        },
        messages: {
            "survey_id": "Choose Survey",
            "question": "Enter Question",
            "question_type": "Choose Question Type",
            "option_a": "Enter Option A",
            "option_b": "Enter Option B",
            "option_c": "Enter Option C",
            "option_d": "Enter Option D",
            "multiple_option_status": "Choose Option Status"
        },
        errorElement: "em",
