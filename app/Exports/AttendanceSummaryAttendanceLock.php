...
class AttendanceSummaryAttendanceLock implements FromView, WithEvents
{
    protected $datas;
    protected $columns;
    protected $year;
    ...
    public function __construct($datas,$columns, $year, $month)
    {
        $this->datas = $datas;
    ...
    {
        return view('exports.monthly-attendance-summary-att-lock', [
            'datas' => $this->datas,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $maxRows = count($this->datas) + 4; // Include header rows and dynamic rows
