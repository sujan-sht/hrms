                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                    <div class="input-group">
                                        {!! Form::select('organization_id', $organizationList, null, ['placeholder' => 'Select Organization',
                                            'id' => 'organization',
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                <div class="input-group engDiv" style="display: none;">
                                    {!! Form::select('eng_calendar_type', $calendarTypeList, request('calendar_type') ?? null, ['placeholder' =>'Select Calendar Type' ,
                                        'class' => 'form-control select-search',
                                    ]) !!}
                                </div>
                                <div class="input-group nepDiv" style="display: none;">
                                    {!! Form::select('calendar_type', $nepcalendarTypeList, request('calendar_type') ?? null, ['placeholder' =>'Select Calendar Type' ,
                                        'id' => 'calendarType',
                                        'class' => 'form-control select-search',
                                    ]) !!}
                                </div>
