...
@section('breadcrum')
<a href="{{ route('reports.tdsReports') }}" class="breadcrumb-item">TDS Report</a>
                ...
                <table class="table table-responsive table-bordered" id="table2excel">
                    <thead>
                        <tr class="text-light btn-slate">
                            ...
                            <th rowspan="2" class="freeze-head">TDS Amount</th>
                    ...
                    <footer>
                        @if(count($payrollEmployees))
                            <tr>
                                ...
                                <td class="text-center">{{ number_format($grandTax, 2)  }}</td>
                            </tr>
                        @endif
                    </footer>
                </table>
