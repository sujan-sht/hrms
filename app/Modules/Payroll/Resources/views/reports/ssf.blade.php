...
@section('breadcrum')
<a href="{{ route('reports.ssfReport') }}" class="breadcrumb-item">SSF Report</a>
                ...
                <table class="table table-responsive table-bordered" id="table2excel">
                    <thead>
                        <tr class="text-light btn-slate">
                            ...
                            <th rowspan="2" class="freeze-head">SSF Amount</th>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            foreach($payrollEmployee->incomes as $k => $incomes){
                                                if($incomes->incomeSetup->short_name == 'SSF'){
                                                    $ssfValue = $incomes->value;
                                                    $ssfGrandTotal += $ssfValue;
                                                }
                                            }
                                        @endphp
                                        {{ number_format($ssfValue, 2)  }}
                                    </td>
                    ...
                    <footer>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ number_format($ssfGrandTotal, 2)  }}</td>
                        </tr>
                    @endif
                    </footer>
                </table>
