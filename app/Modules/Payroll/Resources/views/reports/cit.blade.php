...
@section('breadcrum')
<a href="{{ route('reports.citReport') }}" class="breadcrumb-item">CIT Report</a>
                ...
                <table class="table table-responsive table-bordered" id="table2excel">
                    <thead>
                        <tr class="text-light btn-slate">
                            ...
                            <th rowspan="2" class="freeze-head">CIT Amount</th>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            foreach($payrollEmployee->incomes as $k => $incomes){
                                                if($incomes->incomeSetup->short_name == 'CIT'){
                                                    $citValue = $incomes->value;
                                                    $grandCIT += $citValue;
                                                }
                                            }
                                        @endphp
                                        {{ number_format($citValue, 2)  }}
                                    </td>
                    ...
                    <footer>
                        <tr>
                            ...
                            <td class="text-center">{{ number_format(@$grandCIT, 2)  }}</td>
                        </tr>
                    </footer>
                </table>
            </div>
