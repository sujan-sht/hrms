...
@include('payroll::reports.partial.branch-filter')
                        ...
                        <tbody>
                            ...
                            @foreach ($payrollEmployees as $key => $payrollEmployee)
                                ...
                                @php
                                    ...
                                    $total_days = 0
                                @endphp
                                    {{-- @if ($terminatedDate == null ||  ($terminatedDate && ($payrollModel->year != $terminatedYear && $payrollModel->month != $terminatedMonth))) --}}
                                    <tr class="myLine">
