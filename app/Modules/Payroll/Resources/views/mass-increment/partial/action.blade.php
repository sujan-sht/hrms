        ...
        <tbody>
            ...
            {{-- {{dd($item)}} --}}
                ...
                <tr>
                    ...
                    {!! Form::hidden('existing_income[]',  $item->employeeGrossSalarySetup->gross_salary ?? 0  , ['id'=>'existing_income_'.$item->id, 'class' => 'form-control numeric existing_income'] )!!}
                    <td>{{ '#' . ++$key }}</td>
