    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-grey">
                <h5 class="modal-title font-weight-black ">Import Employee Incomes</h5>
            ...
            <div class="modal-body">
                <div class="bd-import">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>Upload Income salary Data Sheet</h4>
                               <form method="POST" action="{{ route('payroll.uploadEmployeeIncome') }}" accept-charset="UTF-8" class="form-horizontal" role="form" enctype="multipart/form-data" id="gross-salary-form">
                                    @csrf
                                    <div class="position-relative">
                                        <input type="file" class="form-control h-auto" name="upload_employee_income_setup">
                                    </div>
                                ...
                                <div class="mt-3 form-group row list-items-producds/employee_sample/sample_employee.xt alert alert-success" style="border: dashed;border-radius: 25px;border-width: thin;padding: 7px;">
                                    <p class="mt-1"><b>Note:</b> Please make sure, You have correct Employee Income Data Format as similar to Sample Employee Income DataSheet. Data may not be uploaded if missed Any Required Data.</p>
                                </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card mb-0 text-light bg-secondary">
                                <div class="card-body text-center">
                                    ...
                                    <h6>Get Employee Income Data Sample Sheet</h6>
                                    <p>
                                        Before Uploading Employee Income Data - Please make sure, You have correct Employee Income Data Format as similar to Sample Employee Income Data.
                                    </p>
