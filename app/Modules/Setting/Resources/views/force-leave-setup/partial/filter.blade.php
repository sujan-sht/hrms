    ...
    <div class="card-body">
        <form>
            <div class="row">
                ...
                <div class="col-md-3">
                    <label class="d-block font-weight-semibold">OT From Date:</label>
                    <div class="input-group">
                        {!! Form::text('from_date_nep', $value = request('from_date_nep') ?: null, [
                            'placeholder' => 'e.g : YYYY-MM-DD',
                            'class' => 'form-control nepali-calendar from_date_nep',
                            'autocomplete' => 'on',
                        ]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <label class="d-block font-weight-semibold">OT To Date:</label>
                    <div class="input-group">
                        {!! Form::text('to_date_nep', $value = request('to_date_nep') ?: null, [
                            'placeholder' => 'e.g : YYYY-MM-DD',
                            'class' => 'form-control nepali-calendar to_date_nep',
                            'autocomplete' => 'on',
                        ]) !!}
                    </div>
                </div>
                @else
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="example-email" class="form-label">OT Date Range</label>
                            @php
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        @endphp
                        {!! Form::select('status', $statusList, $value = $selectedStatus, [
