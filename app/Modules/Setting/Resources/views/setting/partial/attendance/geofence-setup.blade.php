...
<div class="card">
    <div class="card-body">
        <div class="col-md-6 mb-3">
            <span class="btn btn-outline-warning mx-1 addMap"><i class="icon-plus-circle2"></i>&nbsp;&nbsp;ADD</span>
        </div>
    </div>
</div>
...
<script>
    console.log("============================ GEO OFence Setup AJAX ============================");
    $(document).ready(function() {
        setupCSRFToken();
        //============ setup email submit ===============================
        $('#geofence-submit-ajax').on('submit', function(e) {
            e.preventDefault();

            ajaxSubmit("#geofence-submit-ajax",
                "{{ route('geoFence.storeAjax') }}");
        });
    ...
    console.log("============================ End GEO OFence Setup AJAX ============================");
</script>
