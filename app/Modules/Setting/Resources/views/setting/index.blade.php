...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            //     var popupMsg = 'Are you sure you want to change the synchronization setting?';
            //     var confirmation = confirm(popupMsg);
            //     if (hostName === '') {
            ...
            //         $('input[name="sync"][value="' + (selectedValue === '1' ? '0' : '1') + '"]').prop('checked', true);
            //     }
            // });
