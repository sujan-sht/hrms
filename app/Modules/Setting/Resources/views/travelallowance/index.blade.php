            ...
            <div class="card bd-card">
                <div class="card-body">
                    ...
                    <fieldset class="mb-1">
                        ...
                        <legend class="text-uppercase font-size-sm font-weight-bold">Travel Allowance Setup</legend>

                        <div class="form-group row">
                            <div class="col-lg-6">
                                <div class="row">
                                    <label class="col-form-label col-lg-4">Allowance Type: <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                        @foreach($types as $key=>$type)
                                            <div class="input-group">
                                                <input type="radio" name="allowance_type" value="{{$type}}" {{@$travelAllowanceSetup->allowance_type==$type ? 'checked' :''}} class = "form-check-input" required>
