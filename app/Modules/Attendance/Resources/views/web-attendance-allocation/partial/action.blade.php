        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        <div class="row">
                            <label class="col-form-label col-lg-2">Unit: </label>
                            <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                ...
                <div class="form-group append-clone">
                    @if ($isEdit)
                        {!! Form::hidden('allocation_id', $webAtdAllocation['id'], ['id' => 'allocation']) !!}
                                            ...
                                            <div class="input-group col-lg-10">
                                                {!! Form::select(
                                                    ...
                                                    [
                                                        ...
                                                        'class' => 'form-control department department-filter select-search',
                                                        'required',
                                                    ],
                                                ) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-group col-lg-10">
                                                {!! Form::select(
                                                    'employee_ids[]',
                                                    $employeeList,
                                                    isset($webAtdAllocation['employee_id']) ? json_decode($webAtdAllocation['employee_id']) : null,
                    ...
                    @else
                        @include('attendance::web-attendance-allocation.partial.clone', [
                            'btnType' => 'Create',
                            'count' => 0,
                        ])
                    @endif
...
@section('script')
    <script src="{{ asset('admin/validation/web-atd-allocate.js') }}"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            function checkExist(department_id, that) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ route('webAttendance.checkExists') }}",
                    data: {
                    ...
                    success: function(resp) {
                        if (resp != null && resp == 1) {
                            ...
                            that.find('.errorType').html(
                                '<i class="icon-thumbs-down3 mr-1"></i> This Web Attendance already allocated for above Organization & Sub-Function.'
                            );
            ...
            function appendClone() {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ route('webAttendance.clone.day') }}",
                    data: {
                        count: count,
                    },
