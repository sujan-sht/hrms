...
@section('title') System Reminder @endsection

@section('breadcrum')
    <a class="breadcrumb-item">System Reminders</a>
@endsection

@section('content')
<div class="card">
    <div class="card-body">
        <legend class="text-uppercase font-size-sm font-weight-bold">All System Reminders</legend>
				...
				@foreach($systemReminders as $data)
                    <div class="col-md-4 mb-3">
			            <ul class="media-list">
                            <li class="media">
                                <div class="mr-3">
                                    <a href="{{ $data['link'] }}" class="btn bg-transparent border-{{ $data['color'] }} text-{{ $data['color'] }} rounded-pill border-2 btn-icon">
                                        <i class="{{ $data['icon'] }}"></i>
                                    </a>
                                </div>
