                    ...
                    <tr>
                        <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;"
                            ...
                            <p
                                ...
                                We wanted to bring to your attention that our records indicate you {{ $data['type'] }}than usual today. We understand that unforeseen circumstances may arise from time to time, leading to urgencies and we appreciate your dedication to promptly informing us. While occasional tardiness may occur, we kindly remind you of the importance of adhering to our company's punctuality policy.
                            </p>
                            <div style="text-align:left; font-size: 15px; line-height: 20px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Best Regards,</div>
                            <div style="text-align:left; font-size: 15px; line-height: 20px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">HR Department</div>
                        </td>
                    </tr>
                </tbody>
            </table>
