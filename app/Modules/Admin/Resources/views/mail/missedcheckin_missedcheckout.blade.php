...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
    ...
    <head>
        ...
        <title>Missed Checkin/Checkout Notification</title>
        <!-- End title -->
                    ...
                    <tr>
                        <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;"
                            ...
                            <p
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; We noticed that you missed your <b>{{ $data['type'] }}</b> today ({{ $data['date'] }}). To ensure accurate records, please make sure to <b>{{ $data['type'] }}</b> as soon as possible. If you have already done so, kindly disregard this message.
                                <br>
                                <br>
