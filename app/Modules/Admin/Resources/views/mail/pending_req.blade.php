...
<head>
    ...
    <title>Attendance Request Reminder</title>
    <!-- End title -->
                    ...
                    <tr>
                        <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;"
                            ...
                            <p
                                ...
                                This is a gentle reminder that you have some pending requests that have been awaiting your attention for the past 6 days. 
                                We kindly request you to review and process these requests at your earliest convenience to ensure smooth operations.
                            </p>
