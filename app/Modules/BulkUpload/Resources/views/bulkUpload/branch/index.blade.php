...
@section('breadcrum')
    <a href="{{ route('bulkupload.branch') }}" class="breadcrumb-item">Branch Detail</a>
        ...
        <div class="bd-import">
            <div class="row">
                <div class="col-md-6 px-4">
                    <h4>Upload Branch Detail Data Sheet <span class="text-danger">*</span></h4>
                    <form method="POST" action="{{ route('bulkupload.uploadbranchDetail') }}" accept-charset="UTF-8"
                        class="form-horizontal" role="form" enctype="multipart/form-data" id="employee-form">
                        @csrf
                        <div class="position-relative">
                            <input type="file" class="form-control h-auto" name="upload_family_detail"
                    ...
                    <div class="mt-3 form-group row list-items-producds/employee_sample/sample_employee.xt alert alert-success"
                        ...
                        <p class="mt-1"><b>Note:</b> Please make sure that Before Uploading Branch Detail DataSheet,
                            Please Make Sure, You have Correct and Accurate Data Formate as Similar to Sample Employee
                            Branch Detail DataSheet. Data may not be uploaded if missed Any Required Data.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card mb-0 text-light bg-secondary">
                        <div class="card-body text-center">
                            ...
                            <h6>Get Employee Branch Detail Data Sample Sheet</h6>
                            <p>
                                Before Uploading Employee Branch Detail Data - Please make sure, You have correct Employee
                                Branch Detail Data Format as similar to Sample Employee Data.
                            </p>
                            <a href="{{ asset('samples/Branchfile.xlsx/') }}" target="_blank"
