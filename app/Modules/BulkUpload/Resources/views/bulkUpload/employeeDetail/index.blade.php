...
@section('breadcrum')
    <a href="{{ route('bulkupload.familyDetail') }}" class="breadcrumb-item">Employee Detail</a>
        ...
        <div class="bd-import">
            <div class="row">
                <div class="col-md-6 px-4">
                    <h4>Upload Employee Detail Data Sheet <span class="text-danger">*</span></h4>
                    <form method="POST" action="{{ route('bulkupload.uploadEmployeeDetail') }}" accept-charset="UTF-8"
                        class="form-horizontal" role="form" enctype="multipart/form-data" id="employee-form">
                        @csrf
                        <div class="position-relative">
                            <input type="file" class="form-control h-auto" name="upload_employee_detail"
                    ...
                    <div class="mt-3 form-group row list-items-producds/employee_sample/sample_employee.xt alert alert-success"
                        ...
                        <p class="mt-1"><b>Note:</b> Please make sure that Before Uploading Employee Detail DataSheet,
                            Please Make Sure, You have Correct and Accurate Data Formate as Similar to Sample Employee
                            Detail DataSheet. Data may not be uploaded if missed Any Required Data.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card mb-0 text-light bg-secondary">
                        <div class="card-body text-center">
                            ...
                            <h6>Get Employee Detail Data Sample Sheet</h6>
                            <p>
                                Before Uploading Employee Detail Data - Please make sure, You have correct Employee
                                Detail Data Format as similar to Sample Employee Data.
                            </p>
                            <a href="{{ route('employee-detail-sample-download') }}" target="_blank"
                                class="text-light btn bg-primary btn-labeled btn-labeled-left"><b><i
                                        class="icon-download4"></i></b>Download</a>

                            {{-- <a href="{{ asset('samples/Employee_Detail_Sample.xlsx/') }}" target="_blank"
                                class="text-light btn bg-primary btn-labeled btn-labeled-left"><b><i
                                        class="icon-download4"></i></b>Download</a> --}}
