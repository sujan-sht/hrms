...
@section('breadcrum')
    <a href="{{ route('bulkupload.bankDetail') }}" class="breadcrumb-item">Bank Detail</a>
        ...
        <div class="bd-import">
            <div class="row">
                <div class="col-md-6 px-4">
                    <h4>Upload Bank Detail Data Sheet <span class="text-danger">*</span></h4>
                    <form method="POST" action="{{ route('bulkupload.uploadBankDetail') }}" accept-charset="UTF-8"
                        class="form-horizontal" role="form" enctype="multipart/form-data" id="employee-form">
                        @csrf
                        <div class="position-relative">
                            <input type="file" class="form-control h-auto" name="upload_bank_detail" accept=".xlx, .xlsx" required>
                        </div>
                    ...
                    <div class="mt-3 form-group row list-items-producds/employee_sample/sample_employee.xt alert alert-success"
                        ...
                        <p class="mt-1"><b>Note:</b> Please make sure that Before Uploading Bank Detail DataSheet,
                ...
                <div class="col-md-6">
                    <div class="card mb-0 text-light bg-secondary">
                        <div class="card-body text-center">
                            ...
                            <h6>Get Employee Bank Detail Data Sample Sheet</h6>
                            <p>
                                Before Uploading Employee Bank Detail Data - Please make sure, You have correct Employee
                                Family Detail Data Format as similar to Sample Employee Data.
                            </p>
                            <a href="{{ asset('samples/Bank_Detail_Sample.xlsx/') }}" target="_blank"
