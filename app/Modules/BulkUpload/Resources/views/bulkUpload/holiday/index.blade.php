...
@section('breadcrum')
    <a href="{{ route('bulkupload.holiday') }}" class="breadcrumb-item">Holiday</a>
        ...
        <div class="bd-import">
            <div class="row">
                <div class="col-md-6 px-4">
                    <h4>Upload Holiday Data Sheet <span class="text-danger">*</span></h4>
                    <form method="POST" action="{{ route('bulkupload.uploadHoliday') }}" accept-charset="UTF-8"
                        class="form-horizontal" role="form" enctype="multipart/form-data">
                        @csrf
                        <div class="position-relative">
                            <input type="file" class="form-control h-auto" name="upload_holiday" accept=".xlx, .xlsx"
                                required>
                        </div>
                    ...
                    <div class="mt-3 form-group row list-items-producds/employee_sample/sample_employee.xt alert alert-success"
                        ...
                        <p class="mt-1"><b>Note:</b> Please make sure that Before Uploading Holiday DataSheet,
                            Please Make Sure, You have Correct and Accurate Data Formate as Similar to Sample Employee
                            Holiday DataSheet. Data may not be uploaded if missed Any Required Data.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card mb-0 text-light bg-secondary">
                        <div class="card-body text-center">
                            ...
                            <h6>Get Holiday Data Sample Sheet</h6>
                            <p>
                                Before Uploading Holiday Data - Please make sure, You have correct
                                Holiday Data Format as similar to Sample Employee Data.
                            </p>
                            <a href="{{ asset('samples/Holiday_Sample.xlsx') }}" target="_blank"
