...
<a class="breadcrumb-item active">Claim</a>
@endsection
...
@section('content')
    {!! Form::open([
        'route' => 'overtimeRequest.updateClaimStatus',
        'method' => 'PUT',
        'class' => 'form-horizontal',
        'role' => 'form',
    ]) !!}
        {!! Form::hidden('id', $overtimeRequest->id, []) !!}
        {{-- {!! Form::hidden('employee_id', $overtimeRequest->employee_id, []) !!} --}}
        {{-- {!! Form::hidden('kind', $overtimeRequest->kind, []) !!} --}}
                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="media-list">
                                    ...
                                    {{-- <li class="media mt-2">
                                        ...
                                        <div class="ml-2">{{ setting('calendar_type') == 'BS' ? $overtimeRequest->to_date_nep :  $overtimeRequest->to_date }}</div>
                                    </li> --}}

                                    {{-- <li class="media mt-2">
                                        <span class="font-weight-semibold">Request Days :</span>
                                        <div class="ml-2">{{ $overtimeRequest->request_days }}</div>
                                    </li> --}}
                                    ...
                                    {{-- @if($menuRoles->assignedRoles('overtimeRequest.updateClaimStatus') &&
                                    $overtimeRequest->status == 3 && $overtimeRequest->claim_status == 1
