                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h4>Upload Project Period  Data Sheet</h4>
                                <form method="POST" action="{{ route('unit.uploadUnit') }}" accept-charset="UTF-8" class="form-horizontal" role="form" enctype="multipart/form-data" id="employee-form">
                                    @csrf
                                    <div class="position-relative">
                                        <input type="file" class="form-control h-auto" name="upload_unit">
                                    </div>
                                ...
                                <div class="mt-3 form-group row list-items-producds/employee_sample/sample_employee.xt alert alert-success" style="border: dashed;border-radius: 25px;border-width: thin;padding: 7px;">
                                    <p class="mt-1"><b>Note:</b> Please make sure that Before Uploading Unit DataSheet, Please Make Sure, You have Correct and Accurate Unit Data Formate as Similar to Sample Unit DataSheet. Data may not be uploaded if missed Any Required Data.</p>
                                </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card mb-0 text-light bg-secondary">
                                <div class="card-body text-center">
                                    ...
                                    <h6>Get unit Data Sample Sheet</h6>
                                    <p>
                                        Before Uploading unit Data - Please make sure, You have correct unit Data Format as similar to Sample unit Data.
                                    </p>
                                     <a href="{{asset('downloads/unit/unit-report.xlsx')}}" target="_blank" class="text-light btn bg-primary btn-labeled btn-labeled-left"><b><i class="icon-download4"></i></b>Download</a>
