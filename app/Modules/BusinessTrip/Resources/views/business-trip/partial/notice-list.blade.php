<div class="card">
    <div class="card-body">
        ...
        <label id="basic-error" class="{{ $status ? 'validation-valid-label' : 'validation-invalid-label' }}" for="basic">
            {{-- <label id="basic-error" class="validation-valid-label" for="basic"> --}}
            {{ $finalMessage }}</label>
        @endif
    </div>
</div>
