...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <legend class="text-uppercase font-size-sm font-weight-bold">Allocate Poll</legend>
...
<script src="{{ asset('admin/validation/poll-allocate.js') }}"></script>
