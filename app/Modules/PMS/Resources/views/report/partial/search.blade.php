<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(['route'=>'PMSViewFinalReport','method'=>'GET','class'=>'form-horizontal', 'role'=>'form']) !!}
        <div class="row">
        ...
        <div class="d-flex justify-content-end mt-2">
            ...
            <a href="{{ route('PMSViewFinalReport') }}" class="btn bg-secondary text-white"><i class="icons icon-reset mr-1"></i>Reset</a>
        </div>
        {!! Form::close() !!}
    </div>
</div>
