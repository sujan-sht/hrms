<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(['route'=>'employee-target.view','method'=>'GET','class'=>'form-horizontal', 'role'=>'form']) !!}
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group mb-0 pt-1 pb-1 pl-3 pr-3">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('emp_id', $employee, $selected_emp_id,['class'=>'form-control select-employee select2', 'placeholder'=>'Select Employee']) !!}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end mt-2">
            ...
            <a href="{{ route('employee-target.view') }}" class="btn bg-secondary text-white"><i class="icons icon-reset mr-1"></i>Reset</a>
        </div>
        {!! Form::close() !!}
    </div>
</div>
