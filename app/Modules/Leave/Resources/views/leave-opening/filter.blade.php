<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('leaveOpening.show',['id'=>$id]) }}" method="GET">
            <div class="row">
                ...
                {{-- @if (Auth::user()->user_type == 'super_admin' || Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'hr')
                    <div class="col-md-3 mb-2">
                        ...
                        {!! Form::select('organization_id', $organizationList, $value = request('organization_id') ? : null, ['placeholder'=>'Select Organization', 'class'=>'form-control select-search organization-filter organization-filter2']) !!}
                    </div>
                    <div class="col-md-3 mb-2">
                ...
                {{-- <div class="col-md-3 mb-2">
                    ...
                    {!! Form::select('leave_type_id', $leaveTypeList, $value = request('leave_type_id') ? : null, ['placeholder'=>'Select Leave Type', 'class'=>'form-control select2 leave-type-filter']) !!}
                </div> --}}
                {{-- <div class="col-md-3 mb-2">
                    <label class="form-label">Leave Category</label>
                    {!! Form::select('leave_kind', $leaveKindList, $value = request('leave_kind') ? : null, ['placeholder'=>'Select Leave Category', 'class'=>'form-control select-search']) !!}
                </div> --}}
                <div class="col-md-3 mb-2">
                ...
                <div class="col-md-3 mb-2">
                    <label class="form-label">Leave Type</label>
                    {!! Form::select('leave_type_id', $leaveTypeList, $value = request('leave_type_id') ? : array_key_first($leaveTypeList), [
