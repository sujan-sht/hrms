        ...
        <form action="" method="GET">
            <div class="row">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    {!! Form::select('leave_type_id', $leaveTypeList, $value = request('leave_type_id') ? : null, ['placeholder'=>'Select Leave Type', 'class'=>'form-control select-search']) !!}
                </div>


            </div>
            <div class="d-flex justify-content-end mt-2">
                <button class="btn bg-success mr-2" type="submit">
                    <i class="icon-filter3 mr-1"></i>Create
                </button>
