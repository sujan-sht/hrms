...
.box .card .card-body ul li:first-child {
...
<div class="form-group row">
    ...
    <div class="col-12 col-md-8">
        {!! Form::text('event_date', $value = null, ['id'=>'event_date','class'=>'form-control daterange-single']) !!}
...
<div class="form-group row">
    ...
    <div class="col-12 col-md-8">
        @php $selected_users = $is_edit && !empty($event->tagged_employees) ? json_decode($event->tagged_employees) : null ; @endphp
