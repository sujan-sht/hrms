                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                    ...
                                    @endphp
                                    {!! Form::text('join_date', null, ['placeholder'=>'e.g: YYYY-MM-DD','class'=>$classData,'autocomplete'=>'off']) !!}
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                    ...
                                    @endphp
                                    {!! Form::text('expiry_date', null, ['placeholder'=>'e.g: YYYY-MM-DD','class'=>$classData,'autocomplete'=>'off']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
