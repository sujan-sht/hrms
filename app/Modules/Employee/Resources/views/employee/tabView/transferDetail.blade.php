    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-11">
                        <legend class="text-uppercase font-size-sm font-weight-bold">Transfer History</legend>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody class="employeeTransferTable"></tbody>
                    </table>
                </div>
            </div>
        </div>
...
@include('employee::employee.js.transferDetailJsFunction')
