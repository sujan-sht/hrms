    ...
    <div class="card-body">
        <form action="{{ $route }}" method="GET">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('org_id', $organizationList, $selected_org_id, [
                            'class' => 'form-control select-search organization-filter-confirmation',
                ...
                <div class="col-md-3">
                    <label class="form-label">Probationary/Contract Employee <span class="text-danger">*</span></label>
