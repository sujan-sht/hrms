...
@section('title') Employee Service Events Demotion @endSection
@section('breadcrum')
<a class="breadcrumb-item active">Service Events Demotion</a>
@stop
                ...
                <div class="form-group row mt-2 p-3">
                    <div class="col-md-12">
                                ...
                                <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                                    <div class="input-group">
                                        <select name="contract_type"
                                            ...
                                            @foreach ($contractTypeList as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $value == @$employee->payrollRelatedDetailModel->contract_type ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                                <x-utilities.date-picker :date="@$employeeCareerMobilityDemotion->letter_issue_date ??
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                                <x-utilities.date-picker :date="@$employeeCareerMobilityDemotion->demotion_date ?? request('demotion_date')" mode="both" default="nep"
                                    nepDateAttribute="demotion_date" engDateAttribute="eng_demotion_date" />
