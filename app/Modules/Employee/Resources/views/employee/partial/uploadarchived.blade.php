    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-grey">
                <h5 class="modal-title font-weight-black ">Import Employee</h5>
            ...
            <div class="modal-body">
                <div class="bd-import">
                    <div class="row">
                        <div class="col-md-6">
                            <h4>Upload Project Period Data Sheet</h4>
                                <form method="POST" action="{{ route('employee.uploadEmployeeArchived') }}" accept-charset="UTF-8" class="form-horizontal" role="form" enctype="multipart/form-data" id="employee-form">
                                    @csrf
                                    <div class="position-relative">
                                        <input type="file" class="form-control h-auto" name="upload_employee">
                                    </div>
                                ...
                                <div class="mt-3 form-group row list-items-producds/employee_sample/sample_employee.xt alert alert-success" style="border: dashed;border-radius: 25px;border-width: thin;padding: 7px;">
                                    <p class="mt-1"><b>Note:</b> Please make sure that Before Uploading Employee DataSheet, Please Make Sure, You have Correct and Accurate Employee Data Formate as Similar to Sample Employee DataSheet. Data may not be uploaded if missed Any Required Data.</p>
                                </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card mb-0 text-light bg-secondary">
                                <div class="card-body text-center">
                                    ...
                                    <h6>Get Employee Data Sample Sheet</h6>
                                    <p>
                                        Before Uploading Employee Data - Please make sure, You have correct Employee Data Format as similar to Sample Employee Data.
                                    </p>
                                     <a href="{{asset('downloads/employee_sample/sample_employee.xlsx')}}" target="_blank" class="text-light btn bg-primary btn-labeled btn-labeled-left"><b><i class="icon-download4"></i></b>Download</a>
