    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <h5 class="modal-title font-weight-black text-white ">Import Employee Detail</h5>
                ...
                <div class="bd-import">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <form method="POST" action="{{ route('employee.uploadEmployee') }}" accept-charset="UTF-8"
                            ...
                            <div class="mt-3 form-group row list-items-producds/employee_sample/sample_employee.xt alert alert-success"
                                ...
                                <p class="mt-1"><b>Note:</b> Please make sure that Before Uploading Employee
                                    DataSheet, Please Make Sure, You have Correct and Accurate Employee Data Format as
                                    Similar to Sample Employee DataSheet. Data may not be uploaded if missed Any
                                    Required Data.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card mb-0 text-light bg-secondary">
                                <div class="card-body text-center">
                                    ...
                                    <p>
                                        Before Uploading Employee Data - Please make sure, You have correct Employee
                                        Data Format as similar to Sample Employee Data.
                                    </p>
                                    <a href="{{ route('employee-upload-sample-download') }}" target="_blank"
                                        class="text-light btn bg-primary btn-labeled btn-labeled-left"><b><i
                                                class="icon-download4"></i></b>Download</a>

                                    {{-- <a href="{{ asset('downloads/employee_sample/sample_employee.xlsx') }}"
                                        target="_blank"
                                        class="text-light btn bg-primary btn-labeled btn-labeled-left"><b><i
                                                class="icon-download4"></i></b>Download Sample Sheet</a> --}}
