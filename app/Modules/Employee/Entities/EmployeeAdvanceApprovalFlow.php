...
class EmployeeAdvanceApprovalFlow extends Model
{
    protected $fillable = [
        'employee_id',
        'first_approval',
    ...
    public static function checkAndSaveAdvanceApprovalFlow($data)
    {
        ...
        $model->first_approval = $data['advance_first_approval'];
        $model->last_approval = $data['advance_last_approval'];
        $model->save();
