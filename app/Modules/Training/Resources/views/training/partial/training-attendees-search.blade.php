<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(['route' => ['training.view-training-attendees', $training_id], 'method' => 'get']) !!}
        <div class="row">
            <div class="col-md-3">
        ...
        <div class="d-flex justify-content-end mt-2">
            ...
            <a href="{{ route('training.view-training-attendees', $training_id) }}" class="btn bg-secondary text-white"><i class="icons icon-reset mr-1"></i>Reset</a>
        </div>
        {!! Form::close() !!}
    </div>
</div>
