...
use App\Modules\Survey\Repositories\SurveyQuestionRepository;
...
class SurveyServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->appBindSurvey();
        $this->appBindSurveyQuestion();
    }

    public function appBindSurvey()
    {
        $this->app->bind(
    ...
    public function appBindSurveyQuestion()
    {
        $this->app->bind(
            SurveyQuestionInterface::class,
            SurveyQuestionRepository::class
        );
    }
