...
use App\Modules\Asset\Repositories\AssetQuantityRepository;
...
class AssetServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->appBindAsset();
        $this->appBindAssetQuantity();
        $this->appBindAssetAllocate();
    }

    /**
     *
     */
    public function appBindAsset()
    {
        $this->app->bind(
    ...
    public function appBindAssetQuantity()
    {
        $this->app->bind(
            AssetQuantityInterface::class,
            AssetQuantityRepository::class
        );
    }

    public function appBindAssetAllocate()
    {
        $this->app->bind(
            AssetAllocateInterface::class,
            AssetAllocateRepository::class
        );
    }
