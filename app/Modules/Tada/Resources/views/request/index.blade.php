...
@section('breadcrum')
    <a class="breadcrumb-item active"> TADA / Requests </a>
@endsection
@section('script')
...
@section('content')
    ...
    @include('tada::request.partial.filter')
    ...
    <div class="card card-body">
        <div class="media align-items-center align-items-md-start flex-column flex-md-row">
            ...
            <div class="media-body text-center text-md-left">
                <h6 class="media-title font-weight-semibold">List of All Requests</h6>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr class="text-light btn-slate">
                            ...
                            <th>Status</th>
                            @if (
                                $menuRoles->assignedRoles('tadaRequest.edit') ||
                        ...
                        @if ($tadas->total() > 0)
                            @foreach ($tadas as $key => $tada)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($tada->tadaDetails as $key => $tadaDetail)
                                        {{ optional($tadaDetail->tadaType)->title }}
                                        @if (!$loop->last)
                                            ,
                                        @endif
                                    @endforeach
                                    ...
                                    <td>{{ setting('calendar_type') == 'BS'? $tada->nep_request_date : $tada->eng_request_date}}</td>
                                    ...
                                    @if (
                                        ...
                                        <td class="d-flex">
                                            ...
                                            @endif
                                            @if ($menuRoles->assignedRoles('tadaRequest.downloadPdfRequest'))
                                                <a class="btn btn-outline-warning btn-icon mx-1"
                                                    href="{{ route('tadaRequest.downloadPdfRequest', $tada->id) }}"
                                            ...
                                            @endif
                                            @if ($menuRoles->assignedRoles('tadaRequest.edit') && ($tada->status == '1' || $tada->status == '6'))
