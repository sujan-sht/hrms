...
@section('breadcrum')TADA Management @stop
        ...
        <div class="col-12">
            <div class="card mb-2">
                <div class="card-header">
                    <h6 class="float-left">TADA Management</h6>
                    @if($menuRoles->assignedRoles('employee-tada.create'))
                        <a href="{{route('employee-tada.create')}}" class="btn btn-primary float-right text-white" type="button">Add TADA Request</a>
                    @endif
                </div>
                <div class="card-body table-content">
                    <table class="table">
                        <tr>
                            ...
                            @if($menuRoles->assignedRoles('employee-tada.edit') || $menuRoles->assignedRoles('employee-tada.delete') || $menuRoles->assignedRoles('employee-tada.show'))
                                ...
                                <tr>
                                    ...
                                    @if($menuRoles->assignedRoles('employee-tada.edit') ||  $menuRoles->assignedRoles('employee-tada.delete') || $menuRoles->assignedRoles('employee-tada.show'))
                                        ...
                                        <div class="action-icons">
                                            @if($menuRoles->assignedRoles('employee-tada.show'))
                                                {{--<a class="view view_request" data-toggle="modal" data-target="#modal_view_request"
                                                    data-popup="tooltip" title="View Detail" data-placement="bottom"
                                                    request_id="{{ $tada->id }}">
                                                    <i class="fa fa-eye"></i></a>--}}
                                                <a class="view" data-popup="tooltip" title="View Detail" data-placement="bottom"
                                                 href="{{route('employee-tada.show', $tada->id)}}">
                                                    <i class="fa fa-eye"></i></a>
                                            @endif
                                            @if($menuRoles->assignedRoles('employee-tada.edit') && $tada->status == 'pending')
                                                <a class="edit" href="{{ route('employee-tada.edit', $tada->id) }}"
                                                data-popup="tooltip" data-placement="bottom" title="Edit">
                                                    <i class="fa fa-edit"></i></a>
                                            @endif
                                            @if($menuRoles->assignedRoles('employee-tada.delete') && $tada->status == 'pending')
                                                <a class="delete delete_tada" data-toggle="modal" data-target="#modal_theme_warning"
                                                link="{{ route('employee-tada.delete', $tada->id) }}" data-placement="bottom"
