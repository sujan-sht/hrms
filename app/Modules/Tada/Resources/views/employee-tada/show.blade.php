...
@section('breadcrum')TADA Details @stop
        ...
        <div class="card-body">
            ...
            @if (!empty($tada->excel_file) && file_exists(public_path('uploads/tada/excels/' . $tada->excel_file)))
                <div class="col-md-12">
                    ...
                    <a href="{{ asset('uploads/tada/excels/' . $tada->excel_file) }}" target="_blank" data-popup="tooltip"
                        data-original-title="Tada Excel File">{{ $tada->excel_file }}</a>
                            ...
                            @if (!empty($bill->image_src) && file_exists(public_path('uploads/tada/bills/' . $bill->image_src)))
                                <div class="col-md-12">
                                    ...
                                    <a href="{{ asset('uploads/tada/bills/' . $bill->image_src) }}" target="_blank"
                                        data-popup="tooltip" data-original-title="Bill Image">{{ $bill->image_src }}</a>
