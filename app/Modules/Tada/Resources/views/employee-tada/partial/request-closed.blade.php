<table class="table">
    <tr>
        ...
        <th scope="col">Requested Closed Amount</th>     
        <th scope="col">Requested Closed Remarks</th>     
        <th scope="col">Status</th>  
    </tr>
    @if($closed_requests->total() != 0)
        @foreach($closed_requests as $key=>$value)
            <tr>
                ...
                <td>{{ $value->request_closed_amt }}</td>
                <td>{{ $value->request_closed_remarks }}</td>
                <td class="text-teal">
...
<span style="margin: 5px;float: right;">
    @if($closed_requests->total() != 0)
    {!! $closed_requests->appends(\Request::except('page'))->render() !!}
    @endif
</span>