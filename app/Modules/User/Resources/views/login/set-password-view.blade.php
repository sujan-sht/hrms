                    ...
                    <div class="card mb-0 border-top-teal" style="border-radius: 40px;background-color: #3a606ec9;">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <h5 class="mb-0 mt-2"><b class="text-dark">Change Password</b></h5>
                            </div>
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                {!! Form::hidden('username', $value = $user->username, [
                                    'id' => 'username',
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-warning btn-block"><b>Change Password</b></button>
                            </div>
