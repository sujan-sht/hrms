                ...
                <tbody>
                    @foreach ($activityLogs as $key => $activityLog)
                        <tr>
                            ...
                            <td class="d-flex text-nowrap">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="media-title font-weight-semibold">{{ optional($activityLog->employee)->full_name ?? @getUserDetails($activityLog['created_user_id'],$activityLog['created_user_modal'])->username }}</div>
                            ...
                            <td>
                                {{@getUserDetails($activityLog['created_user_id'],$activityLog['created_user_modal'])->first_name}}
                            </td>
                            <td>
                                @if($activityLog['browser_details'])
                                @foreach(json_decode(@$activityLog['browser_details']) as $key=>$data)
                                    @if($data)
                                        <p>{{@$key}}:{{@$data}}</p>
                                    @endif
                                @endforeach
                            ...
                            <td>
                                ...
                                <a href="{{@$activityLog['route']}}" target="_blank">View</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
