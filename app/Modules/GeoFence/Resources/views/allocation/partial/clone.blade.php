        ...
        <div class="row">
            <div class="col-lg-6 form-group-feedback form-group-feedback-right">
                <div class="row">
                    ...
                    <div class="input-group col-lg-10">
                        {!! Form::select('allocation_details[' . $count . '][department_id]', $departmentList, null, [
                            'placeholder' => 'Select Sub-Function',
                            'class' => 'form-control department select-search',
                            'required',
                        ]) !!}
            ...
            <div class="col-lg-6 form-group-feedback">
                <div class="row">
                    ...
                    <div class="input-group col-lg-10">
                        {!! Form::select('allocation_details[' . $count . '][employee_ids][]', $employeeList, null, [
