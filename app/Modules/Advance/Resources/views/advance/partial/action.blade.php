        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="row items">
                            <label class="col-form-label col-lg-2">Issue Date :<span class="text-danger">
                                    *</span></label>
                            <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                ...
                <div class="row settlementType01 mt-3" style="display: none;">
                    <div class="col-lg-6 mb-3">
                        <div class="row items">
                ...
                {{-- <div id="repeatForm" style="display:block;">
                ...
                <div class="row settlementType03 mt-3" style="display: none;">
                    <div class="col-md-4 mb-3 engMonth">
                        <div class="row items">
                            <label class="col-form-label col-lg-4">Starting Month:</label>
                            <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                    {!! Form::select('eng_starting_month', $monthList, null, [
                                        'placeholder' => 'Select Month',
                                        'class' => 'form-control eng_starting_month select-search',
                                    ]) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3 nepMonth" style="display:none;">
                        <div class="row items">
                            <label class="col-form-label col-lg-4">Starting Month:</label>
                            <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                    {!! Form::select('nep_starting_month', $nepaliMonthList, null, [
                                        'placeholder' => 'Select Month',
                                        'class' => 'form-control nep_starting_month select-search',
                                    ]) !!}
                                </div>
                            </div>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (list.calendar_type == 'nep') {
                            ...
                            $('.nepMonth').show();
                            $('.engMonth').hide();
                            $('.eng_starting_month').val( '');
                        } else {
                            $('.nepDueDate').hide();
                            $('.engDueDate').show();
                            $('.nepMonth').hide();
                            $('.nep_starting_month').val( '');
                            $('.engMonth').show();
                        }
                    }
                });
