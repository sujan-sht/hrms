@inject('advanceSettlementPayment', '\App\Modules\Advance\Entities\AdvanceSettlementPayment')
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <div class="row items">
                            ...
                            <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                    {!! Form::select('organization_id', $organizationList, null, ['id' => 'organization',
                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="row items">
                            <label class="col-form-label col-lg-2">Starting Date :<span class="text-danger">
                                    *</span></label>
                            <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="row items">
                            <label class="col-form-label col-lg-2">Starting Date :</label>
                            <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                    {!! Form::text('from_date', null, [
                ...
                <div class="col-lg-6 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        <div class="p-1 rounded">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                {{ Form::radio('settlement_type', 2, false, ['class' => 'custom-control-input settlementType', 'id' => 'radio2']) }}
                ...
                <div class="settlementType01"
                    style="display: {{ $advanceModel->settlement_type == 1 ? 'block' : 'none' }}">
                    <div class="row mt-3">
                        <div class="col-lg-6 mb-3">
                            <div class="row items">
                                ...
                                <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                    <div class="input-group">
                                        {!! Form::text(
                                            'due_date',
                                            $advanceModel->settlement_type == 1 ? optional($advanceModel->settlementModels[0])->due_date : null,
                                            ['placeholder' => 'YYYY-MM-DD', 'class' => 'form-control daterange-single', 'readonly'],
                                        ) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row items">
                                ...
                                <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                    <div class="input-group">
                                        {!! Form::text(
                                            'total_amount',
                                            $advanceModel->settlement_type == 1 ? optional($advanceModel->settlementModels[0])->amount : null,
                                            ['placeholder' => 'Enter Amount', 'class' => 'form-control numeric'],
                                        ) !!}
                                    </div>
                                </div>
                            </div>
                ...
                <div class="settlementType02"
                    style="display: {{ $advanceModel->settlement_type == 2 ? 'block' : 'none' }}">
                    <div class="mt-3"></div>
                    @if ($advanceModel->settlement_type == 2 && count($advanceModel->settlementModels) > 0)
                        @foreach ($advanceModel->settlementModels as $settlementModel)
                        @php
                        if($calendarType == 'nep'){
                            $advanceSettlementPaymentModel= $advanceSettlementPayment->where('nepali_date',$settlementModel->nepali_due_date)->first();
                        }     
                        else{
                            $advanceSettlementPaymentModel= $advanceSettlementPayment->where('date',$settlementModel->due_date)->first();
                        }
                           
                        @endphp
                            <div class="row oldParent">
                                <div class="col-lg-5 mb-3 engDueDate" style="display:none;">
                                    <div class="row items">
                                        <label class="col-form-label col-lg-2">Due Date :</label>
                                        <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                            <div class="input-group">
                                                @if($advanceSettlementPaymentModel->status == 11)
                                                {!! Form::text('partial_date[]', $settlementModel->due_date, [
                                                    'placeholder' => 'YYYY-MM-DD',
                                                    'class' => 'form-control',
                                                    'readonly',
                                                ]) !!}
                                ...
                                <div class="col-lg-5 mb-3 nepDueDate" style="display:none">
                                    <div class="row items">
                                        ...
                                        <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                            <div class="input-group">
                                                @if($advanceSettlementPaymentModel->status == 11)
                                                {!! Form::text('partial_date_nep[]', $settlementModel->nepali_due_date, [
                                                    'placeholder' => 'YYYY-MM-DD',
                                                    'class' => 'form-control',
                                                    'readonly',
                                                ]) !!}
                                ...
                                <div class="col-lg-5 mb-3">
                                    <div class="row items">
                                        ...
                                        <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                            <div class="input-group">
                                                {!! Form::text('partial_amount[]', $settlementModel->amount, [
                                                    'placeholder' => 'Enter Amount',
                                                    'class' => 'form-control numeric',
                                                ]) !!}
                                            </div>
                                ...
                                {{-- <div class="col-lg-2 mb-3">
                                    <a class="btn btn-danger rounded-pill oldRemove">
                ...
                <div class="settlementType03"
                    style="display: {{ $advanceModel->settlement_type == 3 ? 'block' : 'none' }}">
                    <div class="row mt-3">
                                ...
                                <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                    <div class="input-group">
                                        {!! Form::select(
                                            'starting_month',
                                            $monthList,
                                            $advanceModel->settlement_type == 3 ? optional($advanceModel->settlementModels[0])->starting_month : null,
                                            ['placeholder' => 'Select Month', 'class' => 'form-control select-search'],
                                        ) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row items">
                                ...
                                <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                    <div class="input-group">
                                        {!! Form::text(
                                            'number_of_month',
                                            $advanceModel->settlement_type == 3 ? optional($advanceModel->settlementModels[0])->number_of_month : null,
                                            ['id' => 'numberOfMonth', 'placeholder' => 'Enter Number of Month', 'class' => 'form-control numeric'],
                                        ) !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row items">
                                ...
                                <div class="col-lg-8 form-group-feedback form-group-feedback-right">
                                    <div class="input-group">
                                        {!! Form::text(
                                            'monthly_amount',
                                            $advanceModel->settlement_type == 3 ? optional($advanceModel->settlementModels[0])->amount : null,
                                            ['id' => 'monthlyAmount', 'placeholder' => 'Enter Amount', 'class' => 'form-control', 'readonly'],
                                        ) !!}
                                    </div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            function appendClone() {
                $.ajax({
                    ...
                    success: function(res) {
                        console.log(res)
                        $('#form-repeater').last().append(res.data);
                    }
                });
            }
            ...
            $(document).on('click', '.oldRemove', function() {
                $(this).closest('.oldParent').hide();
            });
