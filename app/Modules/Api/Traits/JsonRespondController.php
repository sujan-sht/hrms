...
trait JsonRespondController
{
    ...
    {
        return response()->json($data, $data['statusCode'] ?? $this->getHTTPStatusCode(), $headers);
    }
    ...
    {
        return $this->setHTTPStatusCode(400)->respond([
            'status' => false,
    ...
    public function respondSuccess($data, $message=null)
    {
        return $this->respond([
            'status' => true,
            'message' => $message ? $message : "Executed Successfully.",
            'data' => $data
        ]);
    }
}
