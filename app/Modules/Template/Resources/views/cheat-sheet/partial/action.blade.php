        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 mb-3">
                        <div class="row">
                            <label class="col-form-label col-lg-2">Short Code:<span class="text-danger"> *</span></label>
                            <div class="col-lg-10 form-group-feedback form-group-feedback-right">
                                <div class="input-group">
                                    {!! Form::text('short_code', null, ['placeholder' => 'Enter Short Code', 'class' => 'form-control']) !!}
                                </div>
                                @if ($errors->has('short_code'))
                                    <div class="error text-danger">{{ $errors->first('short_code') }}</div>
                                @endif
                            </div>
                        </div>
                    </div>
